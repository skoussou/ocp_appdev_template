...
oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-mongodb-WITHPARAMS-NEW-SECRETS.yaml -p DATABASE_SERVICE_NAME=mongodb -p MONGODB_ADMIN_PASSWORD=mongodb -p MONGODB_DATABASE=parks -p MONGODB_PASSWORD=mongodb -p MONGODB_USER=mongodb -l app=mongodb -n ${GUID}-parks-dev
...
# Build locally (no jenkins yet) maven project --> mvn -s ./Infrastructure/nexus_settings.xml clean package -DskipTests=true
...
# Build locally (no jenkins yet) maven project --> mvn -s ./Infrastructure/nexus_settings.xml clean package -Dmaven.test.skip=true
...
# Build locally (no jenkins yet) maven project --> mvn -s ./Infrastructure/nexus_settings.xml clean package spring-boot:repackage -DskipTests -Dcom.redhat.xpaas.repo.redhatga
...
#oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-APP-MLBPARKS-dc-cm-secrets.yaml -p GUID=${GUID} -p APPLICATION_NAME=mlbparks -p CLUSTER_NAME=na39.openshift.opentlc.com -l app=mlbparks -n ${GUID}-parks-dev
oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-APP-MLBPARKS-dc-cm-secrets.yaml -p GUID=${GUID} -p APPLICATION_NAME=mlbparks -p CLUSTER_NAME=$CLUSTER -l app=mlbparks -n ${GUID}-parks-dev
...
#oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-APP-NATIONALBPARKS-dc-cm-secrets.yaml -p GUID=${GUID} -p APPLICATION_NAME=nationalparks -p CLUSTER_NAME=na39.openshift.opentlc.com -l app=nationalparks -n ${GUID}-parks-dev
oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-APP-NATIONALBPARKS-dc-cm-secrets.yaml -p GUID=${GUID} -p APPLICATION_NAME=nationalparks -p CLUSTER_NAME=$CLUSTER -l app=nationalparks -n ${GUID}-parks-dev
...
#oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-APP-PARKSMAP-dc-cm-secrets.yaml -p GUID=${GUID} -p APPLICATION_NAME=parksmap -p CLUSTER_NAME=na39.openshift.opentlc.com -l app=parksmap -n ${GUID}-parks-dev
oc new-app -f ./Infrastructure/templates/devproject/stk-parks-dev-APP-PARKSMAP-dc-cm-secrets.yaml -p GUID=${GUID} -p APPLICATION_NAME=parksmap -p CLUSTER_NAME=$CLUSTER -l app=parksmap -n ${GUID}-parks-dev
