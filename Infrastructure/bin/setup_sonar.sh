...
#oc create -f ./Infrastructure/templates/sonarqube_db.yaml  -n $GUID-sonarqube
...
echo "#####################################################################"
#oc new-app -f ./Infrastructure/templates/sonarqube.yaml -p GUID=$GUID -p PROJECT_NAMESPACE=$GUID-sonarqube -p APPS_CLUSTER_HOSTNAME=apps.na39.openshift.opentlc.com -n $GUID-sonarqube
oc new-app -f ./Infrastructure/templates/sonarqube.yaml -p GUID=$GUID -p PROJECT_NAMESPACE=$GUID-sonarqube -p APPS_CLUSTER_HOSTNAME=$CLUSTER -n $GUID-sonarqube
